...
export function FooterWidgets(){
  ...
  return <>
    {showPill && <div className="floating-audit-pill"><span className="floating-pill-text">Obtenez votre audit de croissance gratuit</span><a href="/free-ai-visibility-audit" className="floating-pill-btn">Demander mon audit gratuit <span aria-hidden="true" className="arrow">↗</span></a><button type="button" className="floating-pill-close" onClick={()=>setShowPill(false)} aria-label="Fermer">✕</button></div>}
